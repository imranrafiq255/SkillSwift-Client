...
const DisputePage = ({ disputes, services }) => {
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="p-6">
          ...
          {['inProgress', 'accepted', 'rejected'].map(tab => (
            <div
              ...
              className={`py-3 px-3 text-sm cursor-pointer transition-colors duration-200 
                ${activeTab === tab ? 'bg-gray-200 text-blue-600' : 'bg-white text-gray-700 hover:bg-gray-100'}`}
        ...
        <div className="grid grid-cols-1 gap-6">
          {disputes
            .filter(dispute => {
              if (activeTab === 'inProgress') return dispute.status === 'inProgress';
              if (activeTab === 'accepted') return dispute.status === 'accepted';
              if (activeTab === 'rejected') return dispute.status === 'rejected';
              return false;
            })
            .map(dispute => (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
              <div>
                ...
                <select
                  ...
                  className={`border rounded-lg w-full p-2 ${errors.service ? 'border-red-500' : ''}`}
                >
              ...
              <div>
                ...
                <input
                  ...
                  className={`border rounded-lg w-full p-2 ${errors.reason ? 'border-red-500' : ''}`}
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`border rounded-lg w-full p-2 ${errors.description ? 'border-red-500' : ''}`}
                />
